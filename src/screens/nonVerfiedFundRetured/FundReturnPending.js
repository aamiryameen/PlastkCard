...
import { idVerificationPending } from '../../assets';
...
export default ForgotPasswordSent = (props) => {
    ...
    return (
        <LinearGradient colors={[theme.GRADIENT_FIRST_COLOR, theme.GRADIENT_SECOND_COLOR]} style={[ForgotPasswordSentStyle.container, { backgroundColor: theme.BACKGROUND_COLOR }]}>
            ...
            />
            <View style={{ flex: 1.4, margin: 20, alignItems: "center", justifyContent: "center", borderRadius: 10, marginTop: normalizeY(30), backgroundColor: theme.BACK_ARROW_BACKGROUND_COLOR }}>
                <Image source={idVerificationPending} resizeMode='cover' style={{ height: 170, width: 170, }} />
            </View>
            <View style={{ flex: 0.4 }}></View>
            <View style={{ alignItems: "center", flex: 1 }}>
                <Text style={{ color: theme.LABEL_COLOR, fontSize: 20 }}>{`     CANADA POST ID 

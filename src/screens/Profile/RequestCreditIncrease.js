                ...
                <Modal
                    ...
                    <View style={{ flex: .3, borderRadius: 10, marginTop: normalizeY(20), ...styles.modalView }}>
                        ...
                        <View style={{ paddingRight: normalizeX(20), alignItems: "flex-start", paddingLeft: normalizeX(10) }}>
                            <Text style={{ ...styles.modalText, fontFamily: mulish_bold, fontSize: 18, color: theme.LABEL_COLOR }}>Credit Line Increase</Text>
                            <Text style={{ ...styles.modalText, fontFamily: mulish_regular, fontSize: 15, color: theme.LABEL_COLOR }}>{`If approved, this amount wil be added to
your existing credit limit.`}</Text>
                        </View>
                            ...
                            <View style={{ flex: 1, margin: 5 }}>
                                ...
                                <View style={{ marginTop: normalizeY(20) }}>
                                    ...
                                    <View style={{ paddingHorizontal: normalizeX(2), paddingTop: normalizeY(10) }}>
                                        <Text style={[signUpScreenStyles.name_style, { paddingTop: normalizeY(10), color: theme.TEXTINPUT_LABEL_COLOR, marginLeft: normalizeY(10) }]}>From</Text>
                                    ...
                                    <View style={{ paddingHorizontal: normalizeX(5) , marginTop: normalizeY(10), paddingTop: normalizeY(10) }}>
                                        {/* label */}
                                        <Text style={[signUpScreenStyles.name_style, { paddingTop: normalizeY(10), marginTop: normalizeY(10), color: theme.TEXTINPUT_LABEL_COLOR }]}>Addittional Amount</Text>
                                        {/* text input container */}
                                    ...
                                    <View style={{ paddingHorizontal: normalizeX(5) }}>
                                        {/* label */}
                                        <Text style={[signUpScreenStyles.name_style, { paddingTop: normalizeY(10), marginTop: normalizeY(10), color: theme.TEXTINPUT_LABEL_COLOR }]}>Deposit will be send to:</Text>
                                        {/* text input container */}
                                        <View style={{ flexDirection: "row", marginHorizontal:normalizeX(6), }}>
                                            <TextInput
                                                placeholder="Securityfunds@plastk.ca"
                                                placeholderTextColor={theme.LABEL_COLOR}
                                                style={[signUpScreenStyles.textinput_style, { color: theme.LABEL_COLOR }]}
                                                autoCapitalize="none"
                                            // onChangeText={(val) => this.textInputChange(val)}
                                    ...
                                    <View style={{ paddingHorizontal: normalizeX(5) }}>
                                        ...
                                        {/* text input container */}
                                        <View style={{ flexDirection: "row", marginHorizontal: normalizeX(5) , }}>
                                            <TextInput

            ...
            <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }} >
                <View style={styles.body}>
                    ...
                    <View style={styles.responseData}>
                        ...
                        <Text style={[styles.name, { color: myTheme.colors.LABEL_COLOR, marginTop: normalizeY(8) }]}>Due Date</Text>
                        <Text style={[styles.email, { color: myTheme.colors.LABEL_COLOR, }]}>3/11/2019</Text>

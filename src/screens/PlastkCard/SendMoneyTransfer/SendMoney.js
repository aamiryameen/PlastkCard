        ...
        <LinearGradient colors={[myTheme.colors.DARK_GRADIENT_FIRST_COLOR, myTheme.colors.DARK_GRADIENT_SECOND_COLOR]} style={styles.container}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}  keyboardShouldPersistTaps={'handled'}>
                ...
                <View style={styles.body}>
                    ...
                    <View style={{ marginLeft: normalizeX(0) }}>
                        <Text style={[styles.placeholder, { color: myTheme.colors.TEXTINPUT_LABEL_COLOR, }]}>From </Text>
                        <View style={[styles.placeholderContainer, { borderBottomColor: myTheme.colors.TEXTINPUT_LABEL_COLOR, marginTop: normalizeY(8) }]}>
                            <Text style={[styles.placeholderText, { color: myTheme.colors.LABEL_COLOR }]}>Plastk Card ({currencyFormatter.format(1000000, { code: 'CAD' })}) </Text>
                        </View>
                    </View>
                    ...
                    <View style={{ flexDirection: "row", marginTop: normalizeY(20), }} >
                        <Picker containerStyle={{
                            ...
                            theme={myTheme} downIcon="down" values={items} placeholder='To' onChange={(val) => aboutUs.current = val} />
                    ...
                    <Picker containerStyle={{
                        marginLeft: 5, width: "90%", borderBottomWidth: StyleSheet.hairlineWidth,
                    ...
                    <Picker containerStyle={{
                        ...
                        theme={myTheme} values={foodItems} placeholder='Security Question' onChange={(val) => foods.current = val} />


                    <View style={{ marginLeft: normalizeX(0) }}>
                        <Text style={[styles.placeholder, { color: myTheme.colors.TEXTINPUT_LABEL_COLOR, }]}>Answer</Text>
                        <View style={[styles.placeholderContainer, { borderBottomColor: myTheme.colors.TEXTINPUT_LABEL_COLOR, marginTop: normalizeY(8) }]}>
                            <Text style={[styles.placeholderText, { color: myTheme.colors.LABEL_COLOR }]}>Pizza</Text>
                        </View>
                    </View>

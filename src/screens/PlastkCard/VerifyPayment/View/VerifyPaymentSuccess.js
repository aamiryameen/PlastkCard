...
export default VerifyPaymentSuccess = (props) => {
    ...
    useEffect(() => {
        ...
        logFireBaseEvent('verify_payment_success')
    ...
    return (
        ...
        <LinearGradient colors={[myTheme.colors.DARK_GRADIENT_FIRST_COLOR, myTheme.colors.DARK_GRADIENT_SECOND_COLOR]}
            ...
            <View style={{ flex: 1, marginTop: normalizeY(30) }}>
                <View style={{ flex: 0.8 }}>
                    <Text style={{ color: myTheme.colors.LABEL_COLOR, textAlign: 'center', fontFamily: mulish_regular, fontWeight: '700', fontSize: normalizeFont(20) }}>PAYMENT POSTED</Text>
